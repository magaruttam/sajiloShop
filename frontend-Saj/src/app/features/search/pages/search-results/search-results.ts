  ...
  products: SearchProduct[] = [
    {
      ...
      subtitle: 'CHYANORA CASHMERE',
      name: 'Classic Ivory Heritage Shawl',
      price: 'NPR 18,500',
      isFavorite: false,
    },
    {
      ...
      badgeColor: 'bg-[#13696A]',
      subtitle: 'NATURAL DYED',
      name: 'Deep Teal Artisan Scarf',
      price: 'NPR 12,200',
      isFavorite: false,
    },
    {
      ...
      name: 'Slate Grey Everyday Scarf',
      price: 'NPR 8,900',
      isFavorite: false,
    },
    {
      ...
      name: 'Crimson Mandala Border Shawl',
      price: 'NPR 24,500',
      isFavorite: false,
    },
    {
    ...
    },
    {
      id: 6,
      image: '/images/clothes.webp',
      subtitle: "WOMEN'S PREMIUM",
      name: 'Dusty Rose Evening Wrap',
      price: 'NPR 16,800',
      isFavorite: false,
    },
    {
      ...
      image: '/images/clothes.webp',
      subtitle: 'REVERSIBLE',
      name: 'Royal Blue Reversible Shawl',
      price: 'NPR 22,000',
      isFavorite: false,
    },
    {
      ...
      subtitle: 'CHYANGRA CASHMERE',
      name: 'Sage Green Pure Cashmere',
      price: 'NPR 19,500',
      isFavorite: false,
    },
  ];
